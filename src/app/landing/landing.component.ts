...
export class LandingComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    // script3.setAttribute("src", "../../assets/js/scripts.js");
    // document.body.appendChild(script3);

  //  await document.getElementById("jquery.min.js").remove();
  //  await document.getElementById("plugins.js").remove();
  //  await document.getElementById("scripts.js").remove();
